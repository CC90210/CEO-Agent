...
CLI:
  python scripts/event_router.py once                  # single tick, exit
  python scripts/event_router.py loop --interval 3     # poll forever
  python scripts/event_router.py tail                  # print latest 20 to stdout
