...
Usage:
    python scripts/sync_mrr.py                        # CC's tenant, write
    python scripts/sync_mrr.py --dry-run              # compute + report, no write
    python scripts/sync_mrr.py --operator other@x.io  # different operator
    python scripts/sync_mrr.py --json                 # machine-readable output
"""
...
def sync(operator_email: str, *, dry_run: bool, as_json: bool) -> dict:
    ...
    snapshot_payload = {
        ...
        "metadata": {
            ...
            "note": "Auto-synced by scripts/sync_mrr.py",
        },
    }
