...
Usage:
    python scripts/system_health_check.py            # full pass
    python scripts/system_health_check.py --json     # machine-readable
    python scripts/system_health_check.py --dry-run  # diagnose only
"""
import argparse
...
def verify_bravo() -> dict:
    audit = _run([PYTHON, str(SCRIPTS / "self_audit.py")], timeout=30)
