...
Usage:
    python scripts/agent_self_improvement.py run [--json]
    python scripts/agent_self_improvement.py run --agents bravo,atlas
"""
...
def format_digest(results: dict[str, Any]) -> str:
    ...
    for name, r in results.items():
        ...
        lines.append("")
    lines.append("Run details: scripts/agent_self_improvement.py run --json")
    return "\n".join(lines).rstrip()
