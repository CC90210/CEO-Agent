...
Usage:
  python scripts/memory_aging.py scan    [--json]
  python scripts/memory_aging.py stale   [--days 30] [--json]
  python scripts/memory_aging.py health  [--json]
  python scripts/memory_aging.py archive [--dry-run] [--json]
"""
