...
USAGE
-----
    python scripts/core/memory_consolidation.py status --json
    python scripts/core/memory_consolidation.py run --dry-run
    python scripts/core/memory_consolidation.py run
    python scripts/core/memory_consolidation.py decay --days 30 --rate 0.95
    python scripts/core/memory_consolidation.py sync-mem0
"""
