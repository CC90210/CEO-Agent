...
Usage:
  python scripts/core/context_manager.py compact [--keep 10] [--dry-run]
  python scripts/core/context_manager.py status
  python scripts/core/context_manager.py tier "<query string>"
  python scripts/core/context_manager.py health
  python scripts/core/context_manager.py health --json
...
def cmd_status(args) -> int:
    ...
    if line_count > 200:
        recommendation = "COMPACT NOW — over 200-line threshold. Run: python scripts/core/context_manager.py compact"
...
CLI_CHECKS = {
    "n8n_tool": {
        ...
        "check": "python_script",
        "script": "scripts/integrations/n8n_tool.py",
        "env_key": "N8N_API_KEY",
    },
    ...
    "stripe_tool": {
        ...
        "check": "python_script",
        "script": "scripts/integrations/stripe_tool.py",
        "env_key": "STRIPE_SECRET_KEY",
    },
    "google_tool": {
        "description": "Gmail, Calendar, Drive",
        "check": "python_script",
        "script": "scripts/integrations/google_tool.py",
        "env_key": "GMAIL_USER",
    },
}
