...
CLI::
    python scripts/core/memory_query.py --task "alejandro retainer" --k 6
    python scripts/core/memory_query.py --task "booking link" --format markdown
    python scripts/core/memory_query.py --task "send gateway" --always-file brain/STATE.md
"""
