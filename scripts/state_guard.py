...
REASON_TEMPLATE = (
    ...
    "  python scripts/state_manager.py log --note \"...\"\n"
    "  python scripts/state_manager.py task add --bucket TODAY --title \"...\"\n"
    "  python scripts/state_manager.py heartbeat --status working\n"
    "Then run `python scripts/state_manager.py export` to regenerate the mirror."
)
