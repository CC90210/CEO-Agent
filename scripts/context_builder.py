...
From the CLI::
    ...
    python scripts/context_builder.py show --lead-id <uuid>
    python scripts/context_builder.py show --email jane@acme.com --json
    python scripts/context_builder.py relationship-map --limit 20
