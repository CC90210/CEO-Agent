...
Usage:
  ...
  python scripts/revenue_engine.py log-revenue --type payment --amount 500 --source manual --client "primary retainer" --notes "March retainer"
...
Examples:
  ...
  %(prog)s dashboard
  %(prog)s sync-stripe
  %(prog)s log-revenue --type payment --amount 500 --source manual --client "primary retainer" --notes "March retainer"
