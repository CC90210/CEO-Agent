...
# function re-running sys.path manipulation. lib/ lives at scripts/lib/
# so we add scripts/ (one level up from this file's directory) to the
# path — NOT this file's own directory.
