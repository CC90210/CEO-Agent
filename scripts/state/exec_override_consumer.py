...
Run as a daemon (PM2 / systemd) on CC's machine:
    ...
    python scripts/state/exec_override_consumer.py loop                # default 5s poll
    python scripts/state/exec_override_consumer.py loop --interval 10
    python scripts/state/exec_override_consumer.py once                # single tick
