...
#
# Usage: bash scripts/hooks/bravo-session-end.sh "one-line summary of what I did"
#        bash scripts/hooks/bravo-session-end.sh --push "one-line summary of what I did"
...
1. bash scripts/hooks/bravo-session-start.sh
