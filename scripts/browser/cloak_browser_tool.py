...
USAGE
-----
  python scripts/browser/cloak_browser_tool.py scrape <url> [--screenshot path] [--headed]
  python scripts/browser/cloak_browser_tool.py goto <url> --eval "<js>"        # one-shot JS eval
  python scripts/browser/cloak_browser_tool.py check-stealth                    # self-test against detection sites
  python scripts/browser/cloak_browser_tool.py binary-info                      # show installed Chromium binary
  python scripts/browser/cloak_browser_tool.py download                         # pre-fetch the ~200MB binary
  python scripts/browser/cloak_browser_tool.py clear-cache                      # wipe binary cache (force redownload)
