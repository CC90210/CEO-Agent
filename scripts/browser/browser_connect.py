...
Usage:
    python scripts/browser/browser_connect.py          # connect (interactive)
    python scripts/browser/browser_connect.py --check  # just check status
    python scripts/browser/browser_connect.py --json   # machine-readable output
"""
