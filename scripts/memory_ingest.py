...
CLI
---
    python scripts/memory_ingest.py --dry-run
    python scripts/memory_ingest.py --force-reembed
    python scripts/memory_ingest.py --only brain/STATE.md
    python scripts/memory_ingest.py --delete-missing   # prune removed files
"""
