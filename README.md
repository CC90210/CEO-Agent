...
- <!-- STATS:skills-->**161 skills**<!-- /STATS -->, <!-- STATS:scripts-->**150 scripts**<!-- /STATS -->, <!-- STATS:sub_agents-->**27 sub-agents**<!-- /STATS -->, <!-- STATS:workflows-->**35 workflows**<!-- /STATS --> (counts auto-regenerated by [`scripts/update_readme_stats.py`](scripts/update_readme_stats.py) — `--check` exits 1 on drift, runs in pre-commit)
