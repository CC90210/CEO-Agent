...
| **Fable 5 model lineup (2026-06-12 standard).** Top-tier reasoning + general agent: `claude-fable-5`. Heavy code/reasoning: `claude-opus-4-8`. General work: `claude-sonnet-4-6`. Cheap classification: `claude-haiku-4-5-20251001`. Vision (statement_parser): Sonnet 4.6 vision is the proven choice. Single source of truth for model IDs lives in `scripts/lib/model_registry.py`. | 0.95 | Anthropic model lineup current as of 2026-06-12 | 2026-06-12 |
