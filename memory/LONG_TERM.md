...
| Supabase projects: Bravo (agent DB + business ops), nostalgic-requests, oasis-ai-platform — all us-west-2. **Turso migration in flight:** 5 isolated Turso (libSQL) DBs replace the 5 Supabase projects; Supabase stays live and paid until the last app cuts over. | 0.95 | supabase_tool list-projects + skills/turso-patterns | 2026-08-08 |
