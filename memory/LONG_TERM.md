...
| Fact | Confidence | Source | Last Verified |
|------|-----------|--------|---------------|
| OASIS AI Solutions at ~$3,322 USD/mo Net MRR ($180 Stripe + $191 base + $2,500 primary retainer flat + $451 primary retainer 15% rev share on $3,007 Skool MRR). Target: $5K USD by May 15, 2026. Live: `python scripts/revenue_engine.py mrr --json` | 0.95 | brain/STATE.md current | 2026-05-06 |
...
| primary retainer relationship is friend-based, contract formalized 2026-04-10. $2,500/mo flat + 15% rev share on Skool community MRR. CC = Head Coach in the prior community. | 0.95 | brain/STATE.md current | 2026-05-06 |
| primary retainer $10K coaching referral DEFERRED — primary retainer currently overcommitted to his own clients. Revisit Q3 2026. | 0.90 | memory/ACTIVE_TASKS.md | 2026-05-06 |
