...
```json
{
  ...
  "clients_active": 3,
  "clients_top": [{"name": "primary retainer", "share_pct": 94}],
...
```json
{
  ...
  "committed_spend_next_30d_cad": 0,
  "next_launch_or_campaign": null,
  "blocker_cfo_needs_to_know": "primary retainer concentration at 94% — need 2-3 non-primary retainer clients before Montreal move"
}
```
