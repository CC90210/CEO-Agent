...
- Revenue diversification -- primary retainer 93% concentration risk is a CEO risk (see brain/RISK_REGISTER.md);
  only the CEO decides when and how to diversify
- Partnership decisions (primary retainer structure, PropFlow with Adon, any future revenue-share arrangements)
...
**Revenue Diversification (HBR):** No client should exceed 15-20% of revenue. primary retainer at 93% is
...
2. **Revenue concentration blindness**: treating primary retainer as stable revenue instead of single-point-of-failure.
...
Atlas always has an answer to: how many months of runway do we have? And: worst case if primary retainer leaves?
...
| Revenue concentration risk | primary retainer % of total (currently 93% -- CRITICAL) |
