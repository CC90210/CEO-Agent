...
| **Breeze** | breeze, merchant-portal, mca-portal, lending-portal, david-portal | `C:\Users\User\APPS\breeze-portal` | [CC90210/breeze-portal](https://github.com/CC90210/breeze-portal) (private) | own project (separate from empire — merchant-data trust boundary) | Next.js 15.5, React 19, TypeScript, Tailwind, Supabase SSR, Plaid, Resend, React Email | Vercel (pending — `breeze.oasisai.work` planned) |
