...
- **Generated at:** 2026-08-19 17:41:45
- **Skills:** 163 active (2 archived in `skills/_archive/`)
- **Python scripts:** 157 top-level production CLI tools under `scripts/` (393 total inc. subpackages, excluding `_archive/` and `__pycache__/`)
