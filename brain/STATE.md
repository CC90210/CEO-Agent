...
- **Result:** Supabase to Turso migration complete for every surface we own: 5 databases parity-verified (no row in Supabase absent from Turso), 4 Vercel apps, 13 VPS daemons, Atlas, Maven, TextTorrent via a PostgREST bridge. 70k+ rows reconciled. 11 PRs. Only APEX (Adon's agent) still writes Supabase - handover is the last step.
...
_Last synced: 2026-08-09T08:00:53.589089+00:00_
