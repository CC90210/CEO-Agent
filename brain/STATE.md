...
> [!success] SunBiz finalization sprint complete — 2026-06-12 <!-- legacy-ok: historical deployment record -->
...
- **Turso tables:** 191 (132 tenant-scoped) — primary backend. Supabase deprecated (legacy apps only).
...
- **Result:** Arthrisil self-review: consolidated plan pricing into lib/pricing.ts (page/charge divergence channel closed, mutation-proven), --json on stripe setup tool; redeployed + re-verified live at qty 1 and 2
