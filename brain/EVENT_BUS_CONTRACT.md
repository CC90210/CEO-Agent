...
| `SUGA_SEAN_SPONSORSHIP_LEAD_RECEIVED` | suga_sean | (broadcast) | info | `lead_id`, `brand_name`, `est_value_usd`, `category` | inbound sponsorship inquiry surfaced for triage |
| `SUGA_SEAN_AFFILIATE_PAYOUT_DUE` | suga_sean | (broadcast) | warn | `payout_id`, `affiliate_id`, `amount_usd`, `period_end` | affiliate commissions ready to disburse |
