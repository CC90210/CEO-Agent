...
| 4 | **Tool Use** | **10/10** | 47 CLI scripts (Stripe, Supabase, n8n, Late/Zernio, Google Workspace, Firecrawl, Playwright). 9 MCP servers synced across 3 configs. Codex delegation for backend work. Tool routing (skills/task-routing). | None. This is Bravo's strongest dimension. |
