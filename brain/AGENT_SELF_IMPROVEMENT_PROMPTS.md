...
- Scan brain/STATE.md (last updated 2026-03-28). References Trading
  ...
  CFO state: $7K liquid, Bennett concentration 94%, FHSA opened,
  pulse contract live.
...
aggregate margin. Extend to per-brand: OASIS margin, Bennett margin,
...
7. Do any of your tax playbooks have Bennett concentration risk as an
...
- Bennett concentration >90% → DEGRADED signal (immediate -15 to score)
