...
### 1. Revenue & Growth
**Goal:** Hit $5,000 USD Net MRR by May 15, 2026
...
| Function | Tool | Command |
|----------|------|---------|
| Content creation | `skills/content-engine/SKILL.md` | `/content` |
| Social publishing | `scripts/late_tool.py` | `/post` |
| Brand voice | `skills/brand-guidelines/SKILL.md` | Consistency enforcement |
...
- [[skills/competitive-intelligence/SKILL]] | [[skills/financial-modeling/SKILL]]
