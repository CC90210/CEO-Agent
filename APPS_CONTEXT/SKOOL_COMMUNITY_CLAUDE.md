---
tags: [brand, skool, bennett, context, revenue, community]
---
...
# Agency Accelerance — Skool Community Partnership with Bennett Spooner

## Overview

Agency Accelerance is a Skool community owned by Bennett Spooner where CC serves as the Head Coach. CC built the entire curriculum, runs 1-on-1 coaching calls, and is responsible for member retention. The community teaches members how to build AI automation agencies.

**Platform:** Skool.com (third-party SaaS — no source code)
**Community name:** Agency Accelerance
**CC's role:** Head Coach + Curriculum Architect
**Bennett's role:** Community Owner + Sales/Marketing
...
## Bennett Spooner — Relationship Context

Bennett is a friend first, business partner second. CC explicitly chose this as a relationship-based partnership rather than a contract-heavy arrangement. The 2026-04-10 contract was created to formalize the verbal agreement without damaging the friendship — protective but not adversarial.

**Key relationship dynamics:**
- Bennett handles sales, marketing, and community ownership
...
**Known upcoming concern (2026-04-10):** Bennett mentioned possibly hiring another coach with more technical background. The contract's Section 7 (Team Expansion and Role Protection) explicitly protects CC's compensation and role against this scenario.
