...
- Background: solid black (#0A0A0A) with a subtle repeating pattern of bold italic capital "A" letters in very dark gray (#1A1A1A) — the the prior community signature texture
