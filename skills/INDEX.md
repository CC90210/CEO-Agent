...
# Skills Index — 149 Specialized Capabilities
...
## Google Workspace
- [[skills/gws-shared/SKILL]] — `gws` CLI reference (auth, global flags, usage)
- **42 per-action skills** (`gws-gmail-send`, `gws-calendar-insert`, etc.) are auto-generated by `gws generate-skills` and loaded on-demand. Hidden from graph to reduce visual clutter. Load directly when needed.
