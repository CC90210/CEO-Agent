...
| Log a manual payment | `revenue_engine.py log-revenue --type payment --amount 500 --source manual --client "Bennett" --notes "March retainer"` |
...
- **Manual retainers:** Logged via `log-revenue --type retainer`. Example: Bennett Community Manager at $2,500/mo.
