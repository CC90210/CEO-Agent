...
3. Ask CC which platform(s): X, LinkedIn, Instagram, Threads, TikTok, YouTube.

4. Draft the content following platform rules:
...
5. Present draft to CC for approval. Iterate if needed.

6. Once approved, run `/post` workflow to publish.
