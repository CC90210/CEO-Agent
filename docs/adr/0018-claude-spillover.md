...
| Z.AI free key (international `api.z.ai` only) | **allowed after smoke** | Its privacy policy says content is processed in real time and not saved on its servers. Same gate. |
