...
const DRILLS: Drill[] = [
  ...
  },
  {
    ...
    chat: {
      agent: "atlas",
      prompt:
        "Today's MRR delta + how we got it. Source breakdown: Stripe one-offs, recurring, primary retainer rev share, Skool growth. If positive, name what to scale tomorrow. If flat or negative, name the one revenue lever I should pull. Be specific to my $5K target by May 15.",
    },
