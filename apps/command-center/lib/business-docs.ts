...
export const BUSINESS_DOCS: BusinessDoc[] = [
  ...
  // ── CFO ─────────────────────────────────────────────────────────
  {
    ...
    status: "drafted",
    draft_prompt:
      "Pull this month's P&L snapshot. Revenue by source (Stripe one-offs, recurring, primary retainer rev share, base, other). Costs by category (tools, contractors, ads, hosting). Net. Compare to last month + the 3-month trend. Flag anything weird.",
  },
  {
    id: "cfo-runway",
    pillar: "cfo", owner: "atlas",
