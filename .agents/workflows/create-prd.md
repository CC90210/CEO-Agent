---
description: Generate a Product Requirements Document for client projects
---
...
2. Research the client's industry and competitors:
   - Use OpenCLI: `opencli twitter search "<industry>" --json`, `opencli reddit search "<industry>" --json`
