...
- **Content Bible**: `memory/content-strategy.md` + `../Marketing-Agent/skills/content-engine/SKILL.md` (voice calibration, hook templates, platform matrix, 7-day calendar, repurposing flow)
