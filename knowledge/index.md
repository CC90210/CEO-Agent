...
> Master catalog of all compiled wiki pages. Read this first for any query or ingest.
> Start here → find the page → read only what you need.
> [[knowledge/SCHEMA]] | [[knowledge/log]] | [[brain/CAPABILITIES]]

## How to Use This Index

**Querying:** Scan the table below. Read only the pages relevant to your question.
**Ingesting:** Check if a target page already exists before creating a new one.
**Linting:** Every page in `knowledge/wiki/` must appear in this table.
...
| primary retainer (historical), rev share, coaching | [[knowledge/wiki/revenue-model]] (archived 2026-05-18) |
...
| MCP, CLI tools, scripts | [[knowledge/wiki/tech-stack]] |
| Skool, community, automation | [[knowledge/wiki/tech-stack]] |
...
_No documents in queue. All raw sources compiled as of 2026-04-06._
